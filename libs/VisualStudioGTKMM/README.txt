This is a complete set of libraries to build gtkmm3 (version 3.16.0) applications on Windows x64
with Visual Studio 2015
The package additionaly includes boost and crypto++ libraries.

All of the libraries are the most recent ones, all of them built with Visual Studio 2015 (msvc-140).

The build type is "Debug x64", that means you can use these libraries to build debug gtkmm3 configuration on
x64 Windows 10. (but it should also work on older windows)
...
OPTION 1: extract the contents of this package into D:\GitHub\Visual-Studio-gtkmm\output\v140\Debug\x64\
...
You also need to edit "Debug-x64.props" and under User Macros provide a correct path to where you extracted this package!
...
That's it, you can now build gtkmm 3.16, boost 1.59, crypto++ 5.6.2 and GTK+ 3.16.7 with Visual Studio 2015!
